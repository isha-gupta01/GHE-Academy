...
const ImageGallery = () => {
  ...
  return (
    ...
    <Updates/>
    <Navbar/>
    <Hero image={SchoolImage}  title="Parents Teacher's Association" subBody="" height={70}/>
    <div className="flex md:flex-row lg:m-20 md:gap-32 sm:flex-col xs:flex-col">
      <div className="min-h-screen flex flex-col items-center p-4">
          
          <div className='flex'>
          <h1 className="text-3xl mt-8 font-bold text-green-700">Parents Teacher's Association</h1>
