...
const ImageGallery = () => {
  const images = [
    "/certificates/class room size certificate.png",
  ];
  ...
  return (
    ...
    <Updates/>
    <Navbar/>
    <Hero image={SchoolImage}  title="Class Room Size Certificate" subBody="" height={70}/>
    <div className="flex md:flex-row lg:m-20 md:gap-32 sm:flex-col xs:flex-col">
      ...
      <div className="min-h-screen flex flex-col items-center p-4">
          ...
          <div className='flex'>
          <h1 className="text-3xl mt-8 font-bold text-green-700">Class Room Size Certificate</h1>
            ...
            <a href="/certificates/class room size certificate.pdf" download className="flex items-center gap-2">
