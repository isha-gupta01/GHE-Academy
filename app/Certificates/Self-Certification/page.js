...
const ImageGallery = () => {
  const images = [
    "/certificates/certification.jpg",
        ...
        <div className="min-h-screen flex flex-col items-center p-4">
          ...
          <div className='flex'>
            ...
            <button className="mt-8 flex items-center gap-2 px-4  text-white rounded-lg hover:scale-150 transition">
              <a href="/certificates/certification.pdf" download className="flex items-center gap-2"><Image src={DownloadIcon} alt="Download" width={20} height={20} /></a>
            </button>
