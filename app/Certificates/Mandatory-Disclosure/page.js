...
// const SchoolInfo = () => {
//   // We don't actually need the router in this implementation
//   const pdfUrl = "/certificates/Mandatory_Disclosure_Details_SARAS_6.0.pdf";

//   // List of available PDFs that can be viewed
//   const availablePdfs = [
...
//                 Click on any document below to view it in a new tab. All official school documents are available for transparency and public access.
//               </p>

//               {/* Featured Document */}
//               <div className="mb-8 bg-green-50 p-4 rounded-lg border border-green-200">
//                 <h3 className="text-lg font-medium text-green-700 mb-2">Featured Document</h3>
...
//                     </div>
//                     <div>
//                       <h4 className="font-medium">Recognition Certificate (RC)</h4>
//                       <p className="text-sm text-gray-500">Official school recognition document</p>
//                     </div>
//                   </div>
//                   <button
...
//                   All documents are provided in PDF format and will open in a new tab. For any questions regarding these documents, please contact the school administration.
//                 </p>
//                 <div className="mt-4">
...
//                     </svg>
//                     greenheavenacademy2011@gmail.com
//                   </a>
