    ...
    <>
      <div>
        ...
        <div className='flex-col mb-10 flex h-auto'>
          <div><h1 className='font-extralight text-[3rem] mt-4 mb-6 lg:ml-10 sm:mx-4'>Art Lab</h1></div>
          <div className='sm:flex-col mx-5 lg:flex-row md:flex-row flex' >
            <Image className='lg:rounded-lg sm:h-auto  sm:w-auto  lg:ml-8 lg:mr-8 lg:h-auto lg:w-[500px] md:h-[400px] md:w-auto' src={Art} alt='art' />
