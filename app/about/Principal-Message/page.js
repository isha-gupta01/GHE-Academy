  ...
  return (
    <>
      ...
      <div className='flex-col flex h-[80vh] '>
        ...
        <div className='sm:flex-col lg:flex-row md:flex-row flex mx-4 ' >
          <Image className='lg:rounded-lg sm:h-auto  sm:w-auto md:h-auto md:w-[400px]  lg:ml-8 lg:mr-8 lg:h-auto lg:w-[500px]' src={Principle} alt='Principal' />
          <div className='mr-8 ml-8 text-justify sm:mr-[2rem] sm:mt-8 '>
