        ...
        <div className={`relative w-full z-0 ${playfair.className}`} style={{ height: `${height}vh` }}>
            ...
            {/* <div className="flex flex-col items-center "> */}
                <div className={`absolute inset-0 flex flex-col  justify-center   text-white px-4 ${playfair.className}`}>
                    <h1 className={`text-3xl md:text-4xl text-[#76B947] lg:text-5xl ${className}`}>{title}</h1>
                    <p className={`text-base md:text-lg lg:text-6xl itallic font-bold text-[#76B947]  mt-2 ${className2}`}>{subBody}</p>
                </div>
            {/* </div> */}
        </div>
    );
